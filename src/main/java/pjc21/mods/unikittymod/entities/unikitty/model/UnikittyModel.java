package pjc21.mods.unikittymod.entities.unikitty.model;
...
public class UnikittyModel <T extends UnikittyEntity> extends OcelotModel<T> {

    private float lieDownAmount;
    private float lieDownAmountTail;
    private float relaxStateOneAmount;

    public UnikittyModel(float p_i51069_1_) {
        super(p_i51069_1_);

        ModelRenderer horn = new ModelRenderer(this);
        horn.setPos(0.0F, 0.0F, 0.0F);
        head.addChild(horn);
        horn.texOffs(13, 22).addBox(-0.5F, -6.0F, 0.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
    }
